...
# ╔═╡ 487c572a-d047-4274-961e-4e94ab8dab18
using Plots
...
bar(
	0:0.5:5.0, hist[:,2] ./ hist[:,1],
	label=nothing,
	xlabel="Distance",
	ylabel="Average relative velocity",
	size=(500,300)
)
...
# ╔═╡ 44e2a692-559d-4d5a-b97b-d6c5f5abbe0b
md"
**Perfomance note:** Julia is column-major, thus the access of the elements of the histogram in the `up_histogram!` function if the histogram shape was `(2,10)` instead of `(10,2)`. 
"
